...
STYLES
//////////////////////////////////////////////////////////////////////////////////////////////////// */
const projectGridContainerStyle = "font-default flex flex-col gap-2 p-0 bg-lightPrimary dark:bg-darkPrimary duration-300 w-96 rounded-lg hover:scale-105 duration-300 shadow-md";
...
export default function ProjectGrid({title, description, status, version, techs, src1, src2, link, github}) {
    ...
    return (
        <div className={projectGridContainerStyle}>
            <img src={src1} alt={title} className="rounded-lg"/>
