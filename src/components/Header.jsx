...
function Header() {
    ...
    STYLES
    ////////////////////////////////////////////////// */
    const headerContainerStyle = "mx-4 lg:mx-[10%] xl:mx-[20%] flex flex-col gap-4 justify-center items-center pt-6";
    ...
    const headerDescriptionCardTextStyle = "font-default font-medium text-textlight uppercase text-md lg:text-lg text-justify";
