...
STYLES
████████████████████████████████████████████████████████████████████████████████████████████████████ */
const introContainerStyle = "px-[10%] xl:px-[20%] py-40 md:py-72 h-screen bg-lightPrimary dark:bg-darkPrimary text-lightText dark:text-darkText border-t border-lightPrimaryBorder dark:border-darkPrimaryBorder flex flex-col gap-24 justify-center items-center";
