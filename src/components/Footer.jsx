...
export default function Footer() {
    ...
    const footerContainerStyle = "flex flex-col justify-between items-center h-full";
    
    const footerContainerUpperStyle = "flex flex-col gap-2 justify-center items-center h-full font-black";
            ...
            <footer id="contact" className={footerStyle}>
                <div className={footerContainerStyle}>
                    <div className={footerContainerUpperStyle}>
                        <p className="text-lg">Seeking a dedicated developer eager to grow?</p>
                        <h1 className="text-9xl z-10">Let's work together</h1>
                        <a href={`mailto:${bill}.${gates}@${gmail}.com?subject=${subject}&body=${body}`} className="dark:border-darkPrimaryBorder w-80 rounded-lg">
